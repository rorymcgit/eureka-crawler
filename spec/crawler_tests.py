...
class TestingCrawler(unittest.TestCase):
    ...
    def test_translastor_called_in_crawl(self):
        ...
        crawler_two.crawl("file:///Users/vicky/Programmes/beetlecrawler/spec/website/index.html")
        self.translator.write_url.assert_called_once_with("file:///Users/vicky/Programmes/beetlecrawler/spec/website/index.html")
