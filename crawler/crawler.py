...
class Crawler():
    ...
    def return_all_content(self):
        ...
        while self.translator.get_weburls_table_size() < self.translator.database_limit and self.translator.get_weburls_and_content_table_size() < self.translator.database_limit:
